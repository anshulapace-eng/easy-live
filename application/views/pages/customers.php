    ...
    <div class="row" id="customers">
        <div id="filter-customers" class="filter-records col col-12 mb-4">
            <?php if (
                ...
                <button id="add-customer" class="btn btn-primary add-record-btn mb-4" style="background: #0052cc; border-color: #0052cc; color: #ffffff;">
        ...
        <div class="record-details col-12 mb-4">
            <div class="btn-toolbar mb-4">
                ...
                <div id="save-cancel-group" style="display:none;">
                    <button id="save-customer" class="btn btn-primary" style="background: #0052cc; border-color: #0052cc; color: #ffffff;">
                        <i class="fas fa-check-square me-2"></i>
                        <?= lang('save') ?>
                    </button>
                    <button id="cancel-customer" class="btn btn-outline-secondary" style="background: #0052cc; border-color: #0052cc; color: #ffffff;" >
                        <?= lang('cancel') ?>
                    </button>
                    <?php if (can('delete', PRIV_CUSTOMERS)): ?>
                        <button id="delete-customer" class="btn btn-outline-danger ms-2" style="background: #0052cc; border-color: #0052cc; color: #ffffff;">
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-6">
                    ...
                    <div id="customer-appointments" class="card border p-3 overflow-auto mb-4" style="min-height: 400px; max-height: 800px; max-width: 330px; width: 100%;">
