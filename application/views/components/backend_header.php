...
<!-- Navbar background changed to bg-white and added border-bottom for clean look -->
<nav id="header" class="navbar navbar-expand-md navbar-light bg-white p-0 border-bottom">
    <div id="header-logo" class="navbar-brand p-1 lh-1">
        <!-- <img src="<?= base_url(
            'assets/img/logo.png',
        ) ?>" alt="logo" class="float-start me-2" style="width: 45px; height: 45px;"> -->
        <h6 class="mb-1 mt-1 fw-bold text-dark" style="font-size: 15px;">Dr. Sahu</h6>
        <small class="d-block text-dark" style="font-size: 12px;">Online Appointment Scheduler</small>
    </div>
    ...
    <div id="header-menu" class="collapse navbar-collapse flex-row-reverse px-2">
        <ul class="navbar-nav">
            ...
            <li class="nav-item text-center <?= $active . $hidden ?>" style="min-width: 100px; color: #000;">
                <a href="<?= site_url(
                    'calendar' . (vars('calendar_view') === CALENDAR_VIEW_TABLE ? '?view=table' : ''),
                ) ?>"
                   class="nav-link text-dark fw-light py-3 px-3"
            ...
            <li class="nav-item text-center <?= $active . $hidden ?>" style="min-width: 100px;">
                <a href="<?= site_url('customers') ?>" class="nav-link text-dark fw-normal py-3 px-3"
                   data-tippy-content="<?= lang('manage_customers_hint') ?>">
                    <i class="fas fa-user-friends me-2 text-dark"></i>
                    <?= lang('customers') ?>
                </a>
            </li>
            ...
            <li class="nav-item dropdown text-center <?= $active . $hidden ?>" style="min-width: 100px;">
                <a class="nav-link dropdown-toggle text-dark fw-normal py-3 px-3" href="#" data-bs-toggle="dropdown"
                   data-tippy-content="<?= lang('manage_services_hint') ?>">
                    <i class="fas fa-business-time me-2 text-dark"></i>
                    <?= lang('services') ?>
                </a>
...
<?php endif; ?>
                    ...
                    <a class="dropdown-item text-danger d-none" href="https://easyappointments.org/premium" target="_blank">
                        <i class="fas fa-crown text-warning me-2"></i>
                        Premium
                    </a>
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item d-none" href="<?= site_url('booking') ?>" target="_blank">
