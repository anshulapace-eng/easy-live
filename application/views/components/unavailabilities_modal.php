    ...
    <div class="modal-dialog modal-dialog-centered modal-fullscreen-lg-down">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button class="btn btn-outline-secondary" data-bs-dismiss="modal" style="background: #0052cc; border-color: #0052cc; color: #ffffff;">
                    <?= lang('cancel') ?>
                </button>
                <button id="save-unavailability" class="btn btn-primary" style="background: #0052cc; border-color: #0052cc; color: #ffffff;">
